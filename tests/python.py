...
class TestUtil(unittest.TestCase):
    ...
    def test_util_culltimeline(self):
        ...
        import pdb
        #pdb.set_trace()
        self.assertEqual(_culltimeline(['2015-04-06T23:05:04-0400'],
                                       "0-1dy: all, 1dy-1wk: 4hr, 1wk-12wk: 1wk, 12wk-1yr: 4wk, 1yr+: none",
                                       1428376600000000), [] )
        self.assertEqual(_culltimeline(['2015-01-06T23:05:04-0400','2015-02-06T23:05:04-0400','2015-03-06T23:05:04-0400'],
                                       "0-1dy: all, 1dy-1wk: 4hr, 1wk-12wk: 1wk, 12wk-1yr: 4wk, 1yr+: none",
                                       1428376600000000), [] )
        self.assertEqual(_culltimeline(['2015-04-06T23:15:04-0400','2015-04-06T23:10:04-0400','2015-04-06T23:05:04-0400'],
                                       "0-1dy: 1hr,1dy-1wk: 2hr, 1yr+: none",
                                       1428376600000000), ['2015-04-06T23:15:04-0400', '2015-04-06T23:10:04-0400'] )

        self.assertEqual(_culltimeline(["2015-04-04T23:05:04-0400","2015-04-06T23:10:04-0400","2015-04-06T23:05:04-0400"],
                                       "0-1yr: 1dy",
                                       1428376600000000), ['2015-04-06T23:10:04-0400'] )
...
class TestExternal(unittest.TestCase):
    ...
    def test_external_runcommand(self):
        from saveme.snapshots import runcommand as _runcommand
